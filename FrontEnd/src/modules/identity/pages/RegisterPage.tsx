    ...
    <div style={s.page}>
      <div style={s.card}>
        ...
        <form onSubmit={handleSubmit} noValidate>
          ...
          <div
            style={{ display: 'flex', alignItems: 'flex-start', gap: '8px', marginBottom: '20px' }}
          >
            <input
              type="checkbox"
              id="transferencias"
          ...
          <button
            type="submit"
            disabled={loading || !aceptaPrivacidad || !aceptaTransferencias}
            style={{
              ...s.button,
              ...(loading || !aceptaPrivacidad || !aceptaTransferencias ? s.buttonDisabled : {}),
            }}
          >
            {loading
              ? 'Creando cuenta…'
